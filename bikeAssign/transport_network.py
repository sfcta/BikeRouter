...
class TransportNetwork(DiGraph):
	"""Network data structure based on Directed Graph object from NetworkX.
	See http://networkx.lanl.gov/contents.html for NetworkX documentation.
	"""
	...
	def __init__(self,config=None):
		...
		if config is not None:
			...
			if 'perform_transformation' in config and config['perform_transformation']==True:
