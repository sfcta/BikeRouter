...
from route_model.traversal.bidirectional_dijkstra import bidirectional_dijkstra
...
import time
import numpy as np
from route_model.misc import get_time_dependent_variable, get_inverse_time_dependent_relation
from math import sqrt
import route_model.misc as rm_misc
from multiprocessing import Lock, Process, current_process, Queue
from scipy.stats import gmean
import sys
from route_model.choice_set.link_elimination import calc_chosen_overlap
...
def filter_master(G,chosen,master_set,choice_set_config):
	config=choice_set_config
	filtered=[]
	L=0
	...
	overlap_idx=choice_set_config['overlap_var']
